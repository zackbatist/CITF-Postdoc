...
> Second, "sampling" is driven not necessarily (or not only) by attempts to be "representative" of some social body or population (or its heterogeneities) but especially and explicitly by theoretical con cerns that have emerged in the provisional analysis.
